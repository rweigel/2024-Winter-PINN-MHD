...
Figure 1 compares the predictions from the PINN and the GAMERA code
for the loop current model. The figures in the left column are nearly
...
Figure 2 is similar to Figure 1, but it compares the PINN and GAMERA
...
Figure 3 compares derived quantities of 3 orders: the RMS error in the
